def send_notification(title: str, message: str, app_icon: str = "", app_name: str = "Douyin Monitor", timeout: int = 10):
...
def should_push_notification(app) -> bool:
    ...
    if settings is None:
        settings = getattr(getattr(app, "services", None), "settings_config", None)
