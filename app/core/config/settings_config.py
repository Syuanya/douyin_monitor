...
from .schema import validate_user_config
...
class SettingsConfig:
    def __init__(self, services):
        ...
        self.user_config: dict = validate_user_config(cm.load_user_config() or {}, self.default_config)
    ...
    def adopt_user_config(self, user_config: dict) -> None:
        ...
        self.user_config = validate_user_config(user_config, self.default_config)
